...
const mapping_entry_1 = require("../mapping-entry");
const path_1 = require("path");
describe("mapping-entry", () => {
    it("should change to absolute paths and sort in longest prefix order", () => {
        const result = (0, mapping_entry_1.getAbsoluteMappingEntries)("/absolute/base/url", {
            "*": ["/foo1", "./foo2"],
    ...
    it("should should add a match-all pattern when requested", () => {
        let result = (0, mapping_entry_1.getAbsoluteMappingEntries)("/absolute/base/url", {}, true);
        expect(result).toEqual([
            {
                pattern: "*",
