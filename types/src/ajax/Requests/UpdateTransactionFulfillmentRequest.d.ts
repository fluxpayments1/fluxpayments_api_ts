...
export declare class UpdateTransactionFulfillmentRequest extends RequestBodyBase {
    private transactionId;
    private fulfillmentCarrier?;
    private fulfillmentTracking?;
    private shippedAt?;
    private deliveredAt?;
    private refundReason?;
    constructor();
    loadClientData(params: UpdateTransactionFulfillmentParams): void;
