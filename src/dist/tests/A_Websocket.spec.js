...
const FluxEntry_2 = require("../lib/FluxEntry");
const FluxSockets_1 = require("../lib/FluxSockets");
const initializeFluxWebSocket = () => __awaiter(void 0, void 0, void 0, function* () {
    let fluxWebSocket = yield (0, FluxEntry_2.fluxSocket)("PK_ewRVuDFJEe61LwJCwKjwBA==", "Z6ZeNlcxdxd9j2Gc1eDwuxkfovDr33BdFaLXZ1y/1Fs=", "mac_98", "your_password");
...
describe("Websocket tests basic", function () {
    ...
    before(() => __awaiter(this, void 0, void 0, function* () {
        yield (0, FluxEntry_1.flux)("PK_ewRVuDFJEe61LwJCwKjwBA==", "Z6ZeNlcxdxd9j2Gc1eDwuxkfovDr33BdFaLXZ1y/1Fs=", "mac_98", "your_password");
        let enumKeys = Object.keys(FluxSockets_1.Subscription);
