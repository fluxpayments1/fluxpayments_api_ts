// import { Product, FluxIdentifier, ProductQuery } from "../flux_types";
...
//             productIds = await fluxObj.createProduct(Product.createInstanceLazy(product));
//         } catch (e: any) {
...
//         try {
//             await fluxObj.createProduct(Product.createInstanceLazy(product));
//         } catch (e: any) {
//             console.error(e.message);
//             duplicatedFluxIdentifierError = true;
//             productIds[0].id = null;
//             deletedFirstFluxIdentifiers = await fluxObj.deleteProduct(productIds);
//         }

//         //Creating a product with an id
//         try {
//             let res = await fluxObj.createProduct(Product.createInstanceLazy({...product, id: 100000}));
...
//         // Negative price test
//         try {
//             await fluxObj.createProduct(Product.createInstanceLazy({ ...product, uniqueId: "SECONDPRODUCT", price: -100.00 }));
//         } catch (e: any) {
//             console.error(e.message);
...
//         try {
//             //@ts-ignore
//             await fluxObj.createProduct({ ...product, uniqueId: "THIRDPRODUCT", type: 'PHYSICAL_PRODUC' });
//         } catch (e: any) {
//             console.error(e.message);
...
//         // No unique id test
//         try {
//             secondProductWithoutUniqueId = await fluxObj.createProduct(Product.createInstanceLazy({ ...product, uniqueId: undefined, name: "PRODUCT 3" }));
//             deletedSecondFluxIdentifiers = await fluxObj.deleteProduct(secondProductWithoutUniqueId);
//         } catch (e: any) {
//             console.error(e.message);
//         }
...
//         try {
//             await fluxObj.createProduct(Product.createInstanceLazy({ ...product, name: 'a'.repeat(300) }));
//         } catch (e: any) {
//             console.error(e.message);
//             longNameError = true;
//         }
...
//         try {
//             thirdProductWithoutUniqueId = await fluxObj.createProduct(Product.createInstanceLazy({ ...product, uniqueId: undefined, name: "PRODUCT 3" }));
//             deletedThirdFluxIdentifiers = await fluxObj.deleteProduct(thirdProductWithoutUniqueId);
//         } catch (e: any) {
//             console.error(e.message);
//         }

//         try {
//             updatedProductFirstCreatedProduct = await fluxObj.createProduct(Product.createInstanceLazy(product));
//             updatedProductByUniqueId = await fluxObj.updateProduct(Product.createInstanceLazy({ ...product, type: "SERVICE" }))
//             await fluxObj.deleteProduct(updatedProductFirstCreatedProduct);
//         } catch (e: any) {
//             console.error(e.message);
//         }

//         try {
//             let subscriptionProductWithoutIntervalError = await fluxObj.createProduct(Product.createInstanceLazy({ ...product, type: "SUBSCRIPTION" }));
//         } catch (e: any) {
//             console.error(e.message);
...
//         try {
//             //@ts-ignore
//             updateInactivatedProduct = await fluxObj.updateProduct(Product.createInstanceLazy({ ...product, activeStatus: true, id: 107 }))
//         } catch (e: any) {
//             console.error(e.message);
//         }
...
//         try {
//             //@ts-ignore
//             updateInactivatedProduct = await fluxObj.updateProduct(Product.createInstanceLazy({ ...product, activeStatus: true, uniqueId: "HELLO" }))
//         } catch (e: any) {
//             console.error(e.message);
//         }
...
//         try {
//             //@ts-ignore
//             updateInactivatedProduct = await fluxObj.updateProduct(Product.createInstanceLazy({ ...product, activeStatus: true, uniqueId: "HELLO", id: 107 }))
//         } catch (e: any) {
//             console.error(e.message);
//         }
...
//         try {
//             firstSearchZeroResult = await fluxObj.getProducts(new ProductQuery({
//                 pagination: {
//                     pageNumber: 1,
//                     itemsPerPage: 500
//                 }
...
//             let id2 = await fluxObj.createProduct(Product.createInstanceLazy(product));

//             secondSearchResult = await fluxObj.getProducts(new ProductQuery({
//                 type: "PHYSICAL_PRODUCT"
//             }))

//             await fluxObj.deleteProduct(id2)

//             //Need to create an entire set of products and query them
//             let ids = await fluxObj.createProduct([
//                 Product.createInstanceLazy({ ...product, uniqueId: "SECONDPRODUCT", name: "PRODUCT 2", category: "CATEGORY 1" }),
//                 Product.createInstanceLazy({ ...product, uniqueId: "THIRDPRODUCT", name: "PRODUCT 3", category: "CATEGORY 2" }),
//                 Product.createInstanceLazy({ ...product, uniqueId: "FOURTHPRODUCT", name: "PRODUCT 4", category: "CATEGORY 2" }),
//                 Product.createInstanceLazy({ ...product, uniqueId: "FIFTHPRODUCT", name: "PRODUCT 5", category: "CATEGORY 1" }),
//                 Product.createInstanceLazy({ ...product, uniqueId: "SIXTHPRODUCT", name: "PRODUCT 6", category: "CATEGORY 1" }),
//                 Product.createInstanceLazy({ ...product, uniqueId: "SEVENTHPRODUCT", name: "PRODUCT 7", category: "CATEGORY 2" }),
//                 Product.createInstanceLazy({ ...product, uniqueId: "EIGHTHPRODUCT", name: "PRODUCT 8", category: "CATEGORY 1" }),
//                 Product.createInstanceLazy({ ...product, uniqueId: "NINTHPRODUCT", name: "PRODUCT 9", category: "CATEGORY 2" }),
//                 Product.createInstanceLazy({ ...product, uniqueId: "TENTHPRODUCT", name: "PRODUCT 10", category: "CATEGORY 1" }),
//             ]);

//             thirdSearchResult = await fluxObj.getProducts(new ProductQuery({
//                 category: "CATEGORY 1",
//             }))

//             fourthSearchResult = await fluxObj.getProducts(new ProductQuery({
//                 category: "CATEGORY 2",
//             }))

//             await fluxObj.deleteProduct(ids)

//             fifthSearchResult = await fluxObj.getProducts(new ProductQuery({}));
...
//         try {
//             let prod: Product = Product.createInstanceLazy({ ...product });

//             //Delete the type
//             delete prod.type;

//             await fluxObj.createProduct(prod);
...
//             let id = await fluxObj.createProduct(Product.createInstanceLazy({ ...product, imageUrl: "asdf" }));
...
//             id = await fluxObj.createProduct(Product.createInstanceLazy({ ...product, imageUrl: "https://google.com" }));
//             await fluxObj.deleteProduct(id);
//             validImageUrl = true;
//         } catch (e: any) {
//             console.error(e.message)
...
//         try {
//             lastSearch = await fluxObj.getProducts(new ProductQuery({}));
//         } catch (e: any) {
//             console.error(e.message)
//         }

//         try {
//             if (id) await fluxObj.deleteProduct(id);
//         } catch(e: any){
...
//         try {
//             await fluxObj.deleteProduct(new FluxIdentifier(undefined, Math.pow(2, 32)))
//         } catch (e: any) {
//             console.log(e.message)
...
//             try {
//                 let productIds = await fluxObj.createProduct(createRandomProduct());
//                 products = products.concat(productIds)
//             } catch (e: any) {
//             }
//         }
//         try {
//             await fluxObj.getProducts(new ProductQuery({
//                 pagination: {
//                     pageNumber: 0,
//                     itemsPerPage: 50
//                 }
...
//         searchedProductsPage1 = await fluxObj.getProducts(new ProductQuery({
//             pagination: {
//                 pageNumber: 1,
//                 itemsPerPage: 50
//             }
...
//         searchedProductsPage2 = await fluxObj.getProducts(new ProductQuery({
//             pagination: {
//                 pageNumber: 2,
//                 itemsPerPage: 50
//             }
...
//         searchedProductsPage3 = await fluxObj.getProducts(new ProductQuery({
//             pagination: {
//                 pageNumber: 3,
//                 itemsPerPage: 50
//             }
...
//         orderedProductsByName = await fluxObj.getProducts(new ProductQuery({
//             pagination: {
//                 pageNumber: 1,
//                 itemsPerPage: 50
//             },
...
//         await fluxObj.deleteProduct(products);
