[fluxpayments](../README.md) / [Modules](../modules.md) / [Wallet](../modules/Wallet.md) / Wallet

# Class: Wallet

[Wallet](../modules/Wallet.md).Wallet
...
- [constructor](Wallet.Wallet.md#constructor)

### Properties

- [active](Wallet.Wallet.md#active)
- [chain](Wallet.Wallet.md#chain)
- [createdAt](Wallet.Wallet.md#createdat)
- [dataTableMetadata](Wallet.Wallet.md#datatablemetadata)
- [id](Wallet.Wallet.md#id)
- [metadata](Wallet.Wallet.md#metadata)
- [obName](Wallet.Wallet.md#obname)
- [obType](Wallet.Wallet.md#obtype)
- [objectType](Wallet.Wallet.md#objecttype)
- [publicAddress](Wallet.Wallet.md#publicaddress)
- [uniqueId](Wallet.Wallet.md#uniqueid)
- [updatedAt](Wallet.Wallet.md#updatedat)

### Methods

- [delete](Wallet.Wallet.md#delete)
- [getId](Wallet.Wallet.md#getid)
- [getObjectType](Wallet.Wallet.md#getobjecttype)
- [merge](Wallet.Wallet.md#merge)
- [persist](Wallet.Wallet.md#persist)
- [refresh](Wallet.Wallet.md#refresh)
- [serialize](Wallet.Wallet.md#serialize)
- [setId](Wallet.Wallet.md#setid)
- [createInstanceLazy](Wallet.Wallet.md#createinstancelazy)
- [createInstanceSafe](Wallet.Wallet.md#createinstancesafe)
- [createObjects](Wallet.Wallet.md#createobjects)
- [createObjectsSafe](Wallet.Wallet.md#createobjectssafe)
- [createObjectsWeb](Wallet.Wallet.md#createobjectsweb)
- [deleteObjects](Wallet.Wallet.md#deleteobjects)
- [generateStatelessSession](Wallet.Wallet.md#generatestatelesssession)
- [getBackendConn](Wallet.Wallet.md#getbackendconn)
- [getLinkedObjectsById](Wallet.Wallet.md#getlinkedobjectsbyid)
- [getObjectsById](Wallet.Wallet.md#getobjectsbyid)
- [getObjectsByIdInternal](Wallet.Wallet.md#getobjectsbyidinternal)
- [instantiateInstance](Wallet.Wallet.md#instantiateinstance)
- [instantiateLazyInstance](Wallet.Wallet.md#instantiatelazyinstance)
- [queryObjects](Wallet.Wallet.md#queryobjects)
- [queryObjectsWeb](Wallet.Wallet.md#queryobjectsweb)
- [updateObjects](Wallet.Wallet.md#updateobjects)

## Constructors

### constructor

• **new Wallet**(`wallet?`): [`Wallet`](Wallet.Wallet.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `wallet?` | `Partial`\<[`IWallet`](../interfaces/IWallet.IWallet.md)\> |
...
[Wallet.d.ts:21](https://github.com/fluxpayments1/fluxpayments_api_ts/blob/2772c747e214a3cab637ab4d18a9d6944f43ee64/src/types/flux_types/Wallet.d.ts#L21)
...
[IWallet](../interfaces/IWallet.IWallet.md).[active](../interfaces/IWallet.IWallet.md#active)

#### Defined in

[Wallet.d.ts:19](https://github.com/fluxpayments1/fluxpayments_api_ts/blob/2772c747e214a3cab637ab4d18a9d6944f43ee64/src/types/flux_types/Wallet.d.ts#L19)
...
[IWallet](../interfaces/IWallet.IWallet.md).[chain](../interfaces/IWallet.IWallet.md#chain)

#### Defined in

[Wallet.d.ts:15](https://github.com/fluxpayments1/fluxpayments_api_ts/blob/2772c747e214a3cab637ab4d18a9d6944f43ee64/src/types/flux_types/Wallet.d.ts#L15)
...
[IWallet](../interfaces/IWallet.IWallet.md).[id](../interfaces/IWallet.IWallet.md#id)
...
[Wallet.d.ts:16](https://github.com/fluxpayments1/fluxpayments_api_ts/blob/2772c747e214a3cab637ab4d18a9d6944f43ee64/src/types/flux_types/Wallet.d.ts#L16)
...
[IWallet](../interfaces/IWallet.IWallet.md).[metadata](../interfaces/IWallet.IWallet.md#metadata)

#### Defined in

[Wallet.d.ts:18](https://github.com/fluxpayments1/fluxpayments_api_ts/blob/2772c747e214a3cab637ab4d18a9d6944f43ee64/src/types/flux_types/Wallet.d.ts#L18)
...
[Wallet.d.ts:4](https://github.com/fluxpayments1/fluxpayments_api_ts/blob/2772c747e214a3cab637ab4d18a9d6944f43ee64/src/types/flux_types/Wallet.d.ts#L4)
...
[Wallet.d.ts:20](https://github.com/fluxpayments1/fluxpayments_api_ts/blob/2772c747e214a3cab637ab4d18a9d6944f43ee64/src/types/flux_types/Wallet.d.ts#L20)
...
[Wallet.d.ts:14](https://github.com/fluxpayments1/fluxpayments_api_ts/blob/2772c747e214a3cab637ab4d18a9d6944f43ee64/src/types/flux_types/Wallet.d.ts#L14)
...
[IWallet](../interfaces/IWallet.IWallet.md).[uniqueId](../interfaces/IWallet.IWallet.md#uniqueid)
...
[Wallet.d.ts:17](https://github.com/fluxpayments1/fluxpayments_api_ts/blob/2772c747e214a3cab637ab4d18a9d6944f43ee64/src/types/flux_types/Wallet.d.ts#L17)
...
[Wallet.d.ts:5](https://github.com/fluxpayments1/fluxpayments_api_ts/blob/2772c747e214a3cab637ab4d18a9d6944f43ee64/src/types/flux_types/Wallet.d.ts#L5)
...
▸ **createInstanceLazy**(`acc`): `Promise`\<[`Wallet`](Wallet.Wallet.md)\>

#### Parameters

| Name | Type |
| :------ | :------ |
| `acc` | `Partial`\<[`IWallet`](../interfaces/IWallet.IWallet.md)\> |

#### Returns

`Promise`\<[`Wallet`](Wallet.Wallet.md)\>

#### Defined in

[Wallet.d.ts:22](https://github.com/fluxpayments1/fluxpayments_api_ts/blob/2772c747e214a3cab637ab4d18a9d6944f43ee64/src/types/flux_types/Wallet.d.ts#L22)

___

### createInstanceSafe

▸ **createInstanceSafe**(`acc`): `Promise`\<[`Wallet`](Wallet.Wallet.md)\>
...
[Wallet.d.ts:23](https://github.com/fluxpayments1/fluxpayments_api_ts/blob/2772c747e214a3cab637ab4d18a9d6944f43ee64/src/types/flux_types/Wallet.d.ts#L23)
