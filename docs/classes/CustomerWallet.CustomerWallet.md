[fluxpayments](../README.md) / [Modules](../modules.md) / [CustomerWallet](../modules/CustomerWallet.md) / CustomerWallet

# Class: CustomerWallet

[CustomerWallet](../modules/CustomerWallet.md).CustomerWallet
...
- [constructor](CustomerWallet.CustomerWallet.md#constructor)

### Properties

- [chain](CustomerWallet.CustomerWallet.md#chain)
- [createdAt](CustomerWallet.CustomerWallet.md#createdat)
- [dataTableMetadata](CustomerWallet.CustomerWallet.md#datatablemetadata)
- [id](CustomerWallet.CustomerWallet.md#id)
- [metadata](CustomerWallet.CustomerWallet.md#metadata)
- [obName](CustomerWallet.CustomerWallet.md#obname)
- [obType](CustomerWallet.CustomerWallet.md#obtype)
- [objectType](CustomerWallet.CustomerWallet.md#objecttype)
- [publicAddress](CustomerWallet.CustomerWallet.md#publicaddress)
- [uniqueId](CustomerWallet.CustomerWallet.md#uniqueid)
- [updatedAt](CustomerWallet.CustomerWallet.md#updatedat)

### Methods

- [delete](CustomerWallet.CustomerWallet.md#delete)
- [getId](CustomerWallet.CustomerWallet.md#getid)
- [getObjectType](CustomerWallet.CustomerWallet.md#getobjecttype)
- [merge](CustomerWallet.CustomerWallet.md#merge)
- [persist](CustomerWallet.CustomerWallet.md#persist)
- [refresh](CustomerWallet.CustomerWallet.md#refresh)
- [serialize](CustomerWallet.CustomerWallet.md#serialize)
- [setId](CustomerWallet.CustomerWallet.md#setid)
- [createInstanceLazy](CustomerWallet.CustomerWallet.md#createinstancelazy)
- [createInstanceSafe](CustomerWallet.CustomerWallet.md#createinstancesafe)
- [createObjects](CustomerWallet.CustomerWallet.md#createobjects)
- [createObjectsSafe](CustomerWallet.CustomerWallet.md#createobjectssafe)
- [createObjectsWeb](CustomerWallet.CustomerWallet.md#createobjectsweb)
- [deleteObjects](CustomerWallet.CustomerWallet.md#deleteobjects)
- [generateStatelessSession](CustomerWallet.CustomerWallet.md#generatestatelesssession)
- [getBackendConn](CustomerWallet.CustomerWallet.md#getbackendconn)
- [getLinkedObjectsById](CustomerWallet.CustomerWallet.md#getlinkedobjectsbyid)
- [getObjectsById](CustomerWallet.CustomerWallet.md#getobjectsbyid)
- [getObjectsByIdInternal](CustomerWallet.CustomerWallet.md#getobjectsbyidinternal)
- [instantiateInstance](CustomerWallet.CustomerWallet.md#instantiateinstance)
- [instantiateLazyInstance](CustomerWallet.CustomerWallet.md#instantiatelazyinstance)
- [queryObjects](CustomerWallet.CustomerWallet.md#queryobjects)
- [queryObjectsWeb](CustomerWallet.CustomerWallet.md#queryobjectsweb)
- [updateObjects](CustomerWallet.CustomerWallet.md#updateobjects)

## Constructors

### constructor

• **new CustomerWallet**(`wallet?`): [`CustomerWallet`](CustomerWallet.CustomerWallet.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `wallet?` | `Partial`\<[`ICustomerWallet`](../interfaces/ICustomerWallet.ICustomerWallet.md)\> |
...
[CustomerWallet.d.ts:19](https://github.com/fluxpayments1/fluxpayments_api_ts/blob/2772c747e214a3cab637ab4d18a9d6944f43ee64/src/types/flux_types/CustomerWallet.d.ts#L19)
...
[ICustomerWallet](../interfaces/ICustomerWallet.ICustomerWallet.md).[chain](../interfaces/ICustomerWallet.ICustomerWallet.md#chain)

#### Defined in

[CustomerWallet.d.ts:14](https://github.com/fluxpayments1/fluxpayments_api_ts/blob/2772c747e214a3cab637ab4d18a9d6944f43ee64/src/types/flux_types/CustomerWallet.d.ts#L14)
...
[ICustomerWallet](../interfaces/ICustomerWallet.ICustomerWallet.md).[id](../interfaces/ICustomerWallet.ICustomerWallet.md#id)
...
[CustomerWallet.d.ts:15](https://github.com/fluxpayments1/fluxpayments_api_ts/blob/2772c747e214a3cab637ab4d18a9d6944f43ee64/src/types/flux_types/CustomerWallet.d.ts#L15)
...
[ICustomerWallet](../interfaces/ICustomerWallet.ICustomerWallet.md).[metadata](../interfaces/ICustomerWallet.ICustomerWallet.md#metadata)

#### Defined in

[CustomerWallet.d.ts:17](https://github.com/fluxpayments1/fluxpayments_api_ts/blob/2772c747e214a3cab637ab4d18a9d6944f43ee64/src/types/flux_types/CustomerWallet.d.ts#L17)
...
[CustomerWallet.d.ts:4](https://github.com/fluxpayments1/fluxpayments_api_ts/blob/2772c747e214a3cab637ab4d18a9d6944f43ee64/src/types/flux_types/CustomerWallet.d.ts#L4)
...
[CustomerWallet.d.ts:18](https://github.com/fluxpayments1/fluxpayments_api_ts/blob/2772c747e214a3cab637ab4d18a9d6944f43ee64/src/types/flux_types/CustomerWallet.d.ts#L18)
...
[CustomerWallet.d.ts:13](https://github.com/fluxpayments1/fluxpayments_api_ts/blob/2772c747e214a3cab637ab4d18a9d6944f43ee64/src/types/flux_types/CustomerWallet.d.ts#L13)
...
[ICustomerWallet](../interfaces/ICustomerWallet.ICustomerWallet.md).[uniqueId](../interfaces/ICustomerWallet.ICustomerWallet.md#uniqueid)
...
[CustomerWallet.d.ts:16](https://github.com/fluxpayments1/fluxpayments_api_ts/blob/2772c747e214a3cab637ab4d18a9d6944f43ee64/src/types/flux_types/CustomerWallet.d.ts#L16)
...
[CustomerWallet.d.ts:5](https://github.com/fluxpayments1/fluxpayments_api_ts/blob/2772c747e214a3cab637ab4d18a9d6944f43ee64/src/types/flux_types/CustomerWallet.d.ts#L5)
...
▸ **createInstanceLazy**(`acc`): `Promise`\<[`CustomerWallet`](CustomerWallet.CustomerWallet.md)\>

#### Parameters

| Name | Type |
| :------ | :------ |
| `acc` | `Partial`\<[`ICustomerWallet`](../interfaces/ICustomerWallet.ICustomerWallet.md)\> |

#### Returns

`Promise`\<[`CustomerWallet`](CustomerWallet.CustomerWallet.md)\>

#### Defined in

[CustomerWallet.d.ts:20](https://github.com/fluxpayments1/fluxpayments_api_ts/blob/2772c747e214a3cab637ab4d18a9d6944f43ee64/src/types/flux_types/CustomerWallet.d.ts#L20)

___

### createInstanceSafe

▸ **createInstanceSafe**(`acc`): `Promise`\<[`CustomerWallet`](CustomerWallet.CustomerWallet.md)\>
...
[CustomerWallet.d.ts:21](https://github.com/fluxpayments1/fluxpayments_api_ts/blob/2772c747e214a3cab637ab4d18a9d6944f43ee64/src/types/flux_types/CustomerWallet.d.ts#L21)
